...
import ProjectCard from "./ProjectCard"; // Import the blogData array from the new file
import projectData from "../ProjectsData";

function Project() {
  return (
    <section className="text-red-600 body-font bg-[#272829]" id="ABout">
       <h1 className="sm:text-3xl text-2xl  title-font mb-4 text-blue-500 text-center font-bold">MY LATEST PROJECTS</h1>
      <div className="container px-5 py-24 mx-auto">
